...
<div id="global">
	...
	<div id="centre">
		...
		<div id="contenu">
			...
			echo "<form method='POST' action='arrivee_action.php'>";
				
			$reponse = $bdd->prepare('SELECT DISTINCT depart FROM trajets WHERE ID_conducteur != :ID AND nbplaces != 0 AND effectue != 1');
			$reponse->execute(array('ID' => $_SESSION['ID']));

			echo "<label for='depart'>Ville de départ: </label>";
