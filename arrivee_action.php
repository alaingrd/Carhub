...
<div id="global">
	...
	<div id="centre">
		...
		<div id="contenu">
			...
			echo "<form method='POST' action='passager_action.php'>";
				
			$req = $bdd->prepare('SELECT DISTINCT arrivee  FROM trajets WHERE depart = :depart AND ID_conducteur != :ID  AND nbplaces != 0');
			$req->execute(array('depart' => $_POST['depart'], 'ID' => $_SESSION['ID']));
			
			$_SESSION['depart'] = $_POST['depart'];

			echo "<label for='arrivee'>Ville d'arrivée: </label>";
