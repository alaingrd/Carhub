...
<div id="global">
	...
	<div id="centre">
		...
		<div id="contenu">
			...
			echo "<form method='POST' action='visualisationCompte_action.php'>";
			$reponse = $bdd->prepare('SELECT login FROM membres WHERE ID != :ID');
			$reponse->execute(array('ID' => $_SESSION['ID']));

			echo "<label for='loginvoulu'>Consulter le profil complet de: </label>";
			echo "<select id='loginvoulu' name='loginvoulu'>";
