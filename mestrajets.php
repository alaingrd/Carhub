	...
	<div id="centre">
		...
		<div id="contenu">
		        ...
		        if (isset($_SESSION['ID']) AND isset($_SESSION['login']))
			{
			    ...
			    echo "<a href='trajetsProposes.php'>Gérer les trajets que je propose</a> <br/>";
			    echo "<a href='trajetsReserves.php'>Gérer les trajets que j'ai réservés</a> <br/>";
			    echo "<a href='historiqueProposes.php'>Historique des trajets que j'ai proposés</a> <br/>";
			}
