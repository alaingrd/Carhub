	...
	<div id="centre">
		...
		<div id="contenu">
		        ...
		        if (isset($_SESSION['ID']) AND isset($_SESSION['login']))
			{
			    ...
			    echo "Vous disposer actuellement de ".$_SESSION['argent']." euros<br/>";
			    echo "<form method='POST' action='argent_action.php'>";
			    echo "<label for='argent'>Veuillez saisir la somme à ajouter à votre compte:<br/></label>";
			    echo "<input type='text' id='argent' name='argent' />";

			    echo "<input type='submit' value='Valider le rechargement' />";
			    echo "</form>";
			}
