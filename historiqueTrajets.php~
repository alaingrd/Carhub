...
*/
			...
			$reponse = $bdd->prepare('SELECT depart, arrivee, datehoraire, nbplaces FROM trajets WHERE ID_conducteur = :ID');
			$reponse->execute(array('ID' => $_SESSION['ID']));


			echo "Les trajets que vous avez proposés sont: <br/>";
			while ($donnees = $reponse->fetch())
			{
			    echo "Ville de départ: ".$donnees['depart']."<br/>";
			    echo "Ville d'arrivee: ".$donnees['arrivee']."<br/>";
			    echo "Date et heure: ".$donnees['datehoraires']."<br/>";
