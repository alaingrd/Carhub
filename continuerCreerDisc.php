	...
	<div id="centre">
		...
		<div id="contenu">
		        ...
		        if (isset($_SESSION['ID']) AND isset($_SESSION['login']))
			{
			    ...
			    echo "<a href='choixInterlocuteurCommencer.php'>Commencer une discussion avec un nouvel interlocuteur</a> <br/>";
			    echo "<a href='choixInterlocuteurContinuer.php'>Continuer une discussion</a> <br/>";
			}
