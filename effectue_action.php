	...
	<div id="centre">
		...
		<div id="contenu">
		        ...
		        if (isset($_SESSION['ID']) AND isset($_SESSION['login']))
			{
				...
				$IDEff = $_POST['choixTrajEff'];


				$req = $bdd->prepare('UPDATE trajets SET effectue = :nveffectue WHERE ID = :ID');
				$req->execute(array(
				    'nveffectue' => 1,
				    'ID' => $IDEff));
				$req->closeCursor();
			...
			echo "Le trajet a été déclaré effectué !<br/>";
			echo "Il n'apparaîtra plus lors des recherches.<br/>";
			echo "Vous pourrez cependant toujours le consulter dans l'historique de vos trajets.<br/>";
			}
